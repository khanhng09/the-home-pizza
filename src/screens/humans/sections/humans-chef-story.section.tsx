  ...
  return (
    <section className="relative overflow-hidden bg-deep">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${humansChefStoryContent.backgroundImageMobile})` }}
        aria-hidden="true"
      />
      <div
        className="absolute inset-0 hidden bg-cover bg-center lg:block"
        style={{ backgroundImage: `url(${humansChefStoryContent.backgroundImage})` }}
        aria-hidden="true"
      />
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="relative flex flex-col gap-8 px-4 py-16 md:px-6 lg:px-8 lg:py-32">
          ...
          <IlustDongHoSauRieng className="pointer-events-none absolute -left-4 bottom-0 h-24 w-24 text-gold/70 sm:h-28 sm:w-28 lg:h-36 lg:w-36" />
        </div>

        {/* Photo column */}
        <div className="relative flex items-center justify-center bg-gold px-8 py-12 lg:py-16">
          <IlustDongHoPizzaDough className="pointer-events-none absolute -right-4 -top-4 hidden h-24 w-24 text-cream/40 lg:block" />
          <img
