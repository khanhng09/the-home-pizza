import { IlustClam, IlustShrimp } from '@/shared/components/illustrations';
  ...
  return (
    <section className="relative overflow-hidden bg-cream">
      <div className="relative">
        ...
        <IlustShrimp className="pointer-events-none absolute left-4 bottom-8 hidden h-24 w-24 text-gold lg:block lg:left-8 lg:h-32 lg:w-32" />
        <IlustClam className="pointer-events-none absolute -right-4 top-4 hidden h-20 w-24 text-gold lg:block lg:h-24 lg:w-28" />
